...
function LoadAssessmentGroupGrid() {
    $.ajax({
        type: "POST",
        url: "StaffAssessmentResult.aspx/GetAssessmentGroupGrid",
        data: "",
...
function LoadWorkingSection(mValue) {
    $.ajax({
        type: "POST",
        url: "StaffAssessmentResult.aspx/GetWorkingSection",
...
function Query() {
    if (mProductionID == "" && mWorkingSectionID == "" && mGroupId == "" && mStatisticalCycle == "") {
        ...
        LoadColumns();
        mUrl = "StaffAssessmentResult.aspx/GetAllAssessmentResult";
...
function LoadColumns() {
    ...
    $.ajax({
        type: "POST",
        url: "StaffAssessmentResult.aspx/GetGetCloumnStringDetail",
        ...
        dataType: "json",
        success: function (msg) {
            var frozenData = jQuery.parseJSON(msg.d).frozenColumns;
            var myData = jQuery.parseJSON(msg.d).columns;
            $('#grid_Main').datagrid({
                frozenColumns: [frozenData],
                columns: [myData],
            });
        },
        error: function () {
...
function AssessmentResultdetail(mAssessmentId) {
    ...
    $.ajax({
        type: "POST",
        url: "StaffAssessmentResult.aspx/GetAssessmentResultdetail",
